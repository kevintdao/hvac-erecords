...
class UnitModelTests(TestCase):
    ...
    def test_created_invalid_unit(self):
        with self.assertRaises(DataError):
            Unit.objects.create(external_id="",building=Building.objects.first(),category="AC",serial_number='1'*256,model_number="1234A00",manufacturer="Trane",production_date=datetime.date(2015,10,20))