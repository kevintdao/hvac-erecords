...
class UnitModelTests(TestCase):
    def test_created_valid_unit(self):
        Unit.objects.create(external_id="",category="AC",serial_number="24ABC542W003102",model_number="1234A00",manufacturer="Trane",production_date=datetime.date(2015,10,20))
