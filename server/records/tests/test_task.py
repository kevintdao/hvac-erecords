...
class TaskModelTests(TestCase):
    ...
    def test_created_valid_task(self):
        Task.objects.create(company = Company.objects.first(), title='Check refrigerant level',description='report a value based response for refrigerant level',rule={'name': 'selection', 'options': {'1': 'Yes', '2': 'No'}})
